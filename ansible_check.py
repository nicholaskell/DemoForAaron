...
NEW_BRANCH_NAME = "ai-improved-ansible-3"
...
No matter what, when adding comments, make sure to use the # symbol at the start of every commented line. We will need to be able to run the files as is to test the changes.
"""
